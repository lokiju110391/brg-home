        ...
        <script type="text/javascript">
            ...
            function abre_fecha_menu() {
              if($("#menu-mobile").is(":visible")) {
                ...
                $("#icon-menu-mobile").addClass("fa-angle-up").removeClass("fa-angle-down");    
              }
            }

            function abre_fecha_menu_drop() {
              if($("#drop-down-produto").is(":visible")) {
                $("#drop-down-produto").slideUp("fast");
              } else {
                $("#drop-down-produto").slideDown("fast");
              }
            }
    ...
    <body>
        ...
        <div id="menu-mobile" class="navbar-platta-mobile-menu d-md-none" style="display: none;">
            ...
            <div class="paginas-mobile" style="padding-top: 10px;">               
                ...
                <div class="text-center" style="padding-top: 10px;">                        
                    <a class="header-font" onclick="auto_scroll_to('about_us')">
                        SOBRE NÓS
                    </a>
                </div>

                <div class="text-center" style="padding-top: 10px;">                        
                    <a class="header-font" onclick="auto_scroll_to('team')">
                        PROFISSIONAIS
                    </a>
                </div>

                <div class="text-center" style="padding-top: 10px;">                        
                    <a class="header-font" onclick="auto_scroll_to('sector')">
                        ATUAÇÃO
                    </a>
                </div>

                <div class="text-center" style="padding-top: 10px;">                        
                    <a class="header-font" onclick="auto_scroll_to('news')">
                        NOTÍCIAS
                    </a>
                </div>

                <div class="text-center" style="padding-top: 10px;">                        
                    <a class="header-font" onclick="auto_scroll_to('contact')">
                        CONTATO
                    </a>
                </div>                
                ...
                <div class="container d-flex justify-content-between" style="width: 100%; margin-bottom: 15px;">
                    <div class="row alinhamento-central">
                        <div class="col-md-9">
                           ...
                           <a class="p-2 menu-text-branco" onclick="auto_scroll_to('about_us')">SOBRE NÓS</a>
                           <a class="p-2 menu-text-branco" onclick="auto_scroll_to('team')">PROFISSIONAIS</a>
                           <a class="p-2 menu-text-branco" onclick="auto_scroll_to('sector')">ATUAÇÃO</a>
                           <a class="p-2 menu-text-branco" onclick="auto_scroll_to('news')">NOTÍCIAS</a>
                           <a class="p-2 menu-text-branco" onclick="auto_scroll_to('contact')">CONTATO</a>
                        </div>
                  ...
                  <div class="bunner-principal">
                     <div style="display: table; height: 100%; width: 100%;">
                        <div style="display: table-cell; vertical-align: middle;">  
                           ...
                           <h2 class="titulo-branco" style="padding-top: 45px;">Soluções jurídicas eficientes.</h2>
        ...
        <div class="container">
            ...
            <div id="about_us" name="about_us"  class="text-center title-session-color">
                <h1>APRESENTAÇÃO</h1>
            </div>
        ...
        <div class="campo-proficionais">
            ...
            <div class="container">
                <div id="team" name="team" class="text-center title-session-white">               
                    <h1>EQUIPE</h1>
                </div>
        ...
        <div class="campo-atuacao">
            <div class="container">
                ...
                <div id="sector" name="sector" class="text-center title-session-brow">                
        ...
        <div class="campo-noticias">
            <div class="container">
                ...
                <div id="news" name="news" class="text-center title-session-brow">                
                    <h1>NOTÍCIAS</h1>
                </div>
        ...
        <div class="campo-contato">
            ...
            <div class="text-center" style="padding-top: 120px;">
                ...
                <br>
                <br>
                <span class="simple-bold simple-white">Copyright © 2019 - BRG Advogados</span> <br>
                <span class="simple-bold simple-white">OAB/PR n° 8.823</span>
